...
router.post('/create-expertise', auth(), staffPermission([STAFF_ROLES.ADMIN]),
    validate(expertiseValidation.createExpertise), expertiseController.createExpertise);

router.post('/update-expertise', auth(), staffPermission([STAFF_ROLES.ADMIN]),
    validate(expertiseValidation.updateExpertise), expertiseController.updateExpertise);
